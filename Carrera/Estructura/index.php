					...
					<tr>
						<td><div class="row">
							...
							<div class="col-xs-5 col-sm-5 col-md-6 col-lg-5 text-center"> 
								<i class="fa fa-search fa-fw consultar" title="Mas información" onClick="moreInfo('moduloPlanificacion/Carrera/Estructura/consultar.php', 'nombre=<?= $estructura->nombre ?>')"></i>
