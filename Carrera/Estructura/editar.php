...
<div class="row">
	<div class="col-lg-12">
		<form name="estructura" method="POST" action="moduloPlanificacion/Carrera/Estructura/modificar.php" data-exe="embem('moduloPlanificacion/Carrera/Estructura/index.php', '#page-wrapper')" role="form">
...
?>
			...
			<div class="form-group text-center">
				...
				<input type="button" value="Cancelar" class="btn btn-lg" onClick="embem('moduloPlanificacion/Carrera/Estructura/index.php', '#page-wrapper')" />
			</div>
		</form>
	</div>
</div>
