...
<div class="row">
	<div class="col-xs-12">
		<form name="malla" method="POST" action="moduloPlanificacion/Carrera/Malla/reutilizar.php" data-exe="embem('moduloPlanificacion/Carrera/Malla/index.php', '#page-wrapper')" role="form">
...
?>
			...
			<div class="form-group text-center">
				...
				<input type="button" value="Cancelar" class="btn btn-lg" onClick="embem('moduloPlanificacion/Carrera/Malla/index.php', '#page-wrapper')" />
			</div>
		</form>
	</div>
</div>
...
<script>
	function selectES(carrera) {
		...
		embem('moduloPlanificacion/Carrera/Malla/estructuras.php', document.malla.estructura, "carrera=" + carrera);
		embem('moduloPlanificacion/Carrera/Malla/sedes.php', "#sedes", "carrera=" + carrera);
	}
	...
	function estructuraMalla(carrera, estructura) {
		...
		embem('moduloPlanificacion/Carrera/Malla/malla.php', "#malla", "carrera=" + carrera + "&estructura=" + estructura);
	}
</script>