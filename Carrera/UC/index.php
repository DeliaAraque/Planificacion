...
?>
				...
				<tfoot>
					<tr>
						<td class="text-center" title="Nueva unidad curricular" onClick="embem('moduloPlanificacion/Carrera/UC/form.php', '#page-wrapper')" style="cursor: pointer" colspan="4"><i class="fa fa-plus fa-fw agregar"></i></td>
					</tr>
				</tfoot>
			</table>
		</div>
