...
<div class="row">
	<div class="col-xs-12">
		<form name="unidadCurricular" method="POST" action="moduloPlanificacion/Carrera/UC/guardar.php" data-exe="embem('moduloPlanificacion/Carrera/UC/index.php', '#page-wrapper')" role="form">
...
?>
			...
			<div class="form-group text-center">
				...
				<input type="button" value="Regresar" class="btn btn-lg" onClick="embem('moduloPlanificacion/Carrera/UC/index.php', '#page-wrapper')" />
			</div>
		</form>
	</div>
</div>