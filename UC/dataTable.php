...
?>
			...
			"<div class=\"row\"> <div class=\"col-xs-7 col-sm-7 col-md-6 col-lg-7\"> <?= $uc->eje; ?> </div> <div class=\"col-xs-5 col-sm-5 col-md-6 col-lg-5 text-center\"> <i class=\"fa fa-pencil fa-fw editar\" title=\"Editar\" onClick=\"embem('moduloPlanificacion/UC/editar.php', '#page-wrapper', 'id=<?= $uc->id ?>')\"></i> <i class=\"fa fa-trash-o fa-fw eliminar\" onClick=\"if(confirm('¿Realmente desea eliminar <?= $uc->nombre ?>?')) sendReq('../../script/eliminar.php', 'tabla=unidadCurricular&campo=id&valor=<?= $uc->id ?>', 'moduloPlanificacion/UC/index.php')\" title=\"Eliminar\"></i> </div> </div>"
		],
