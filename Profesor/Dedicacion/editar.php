...
<div class="row">
	<div class="col-lg-12">
		<form name="dedicacion" method="POST" action="moduloPlanificacion/Profesor/Dedicacion/modificar.php" data-exe="embem('moduloPlanificacion/Profesor/Dedicacion/index.php', '#page-wrapper')" role="form">
			<div class="form-group">
				Abreviatura:
				<input type="text" name="id" value="<?= $id; ?>"placeholder="Abreviatura" class="form-control" pattern="^[a-záéíóúñA-ZÁÉÍÓÚÑ0-9]+$" onKeyUp="if(this.value != document.dedicacion.idAnt.value) Verif(this)" required="required" />
				<input type="hidden" name="idAnt" value="<?= $id; ?>" />
				<p class="help-block">Solo están permitidos caracteres alfanuméricos sin espacios. Ej: MT.</p>
			</div>
			...
			<div class="form-group text-center">
				...
				<input type="button" value="Cancelar" class="btn btn-lg" onClick="embem('moduloPlanificacion/Profesor/Dedicacion/index.php', '#page-wrapper')" />
			</div>
		</form>
	</div>
</div>