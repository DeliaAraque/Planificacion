	...
	<tr id="<?= $periodo->id; ?>"><td>
		...
		<div class="row">
			<div class="form-group col-xs-6">
				<input type="text" name="ht<?= $n; ?>" placeholder="Horas teóricas" class="form-control" pattern="^[0-9]+$" required="required" />
			...
			<div class="form-group col-xs-6">
				<input type="text" name="hp<?= $n; ?>" placeholder="Horas prácticas" class="form-control" pattern="^[0-9]+$" required="required" />
